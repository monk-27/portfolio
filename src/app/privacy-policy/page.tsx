                ...
                <div className="container mx-auto max-w-4xl">
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            ...
                            website. We are committed to protecting your privacy
                            and ensuring that your personal information is
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            <strong>1. Personal Information:</strong> We may
                            collect personal information such as your name,
                            email address, and other contact details when you
                            voluntarily provide them through contact forms,
                            newsletter sign-ups, or when you communicate with
                            us.
                        </p>
                        <p className="text-lg">
                            <strong>2. Usage Data:</strong> We automatically
                            collect certain information when you visit our
                            website. This may include your IP address, browser
                            type, device information, operating system, the
                            pages you visit, and the time and date of your
                            visit. This data helps us understand how our
                            visitors use the site and improve its functionality.
                        </p>
                        <p className="text-lg">
                            <strong>
                            ...
                            include an anonymous unique identifier. You can
                            instruct your browser to refuse all cookies or to
                            indicate when a cookie is being sent. However, if
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            ...
                            personal information to outside parties. However, we
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            ...
                            seriously. We implement a variety of security
                            measures to maintain the safety of your personal
                            information. However, please be aware that no method
                            of transmission over the internet, or method of
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            ...
                            sites you visit through external links.
                        </p>
                    </section>
                    ...
                    <section className="mb-6">
                        ...
                        <p className="text-lg">
                            ...
                            updated "Last Updated" date. We encourage you to
