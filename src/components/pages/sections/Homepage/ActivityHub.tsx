...
export default function ActivityHub(props: IAnalyticsProps) {
    return (
        <div className="container mx-auto relative mt-10 flex-col-center-center gap-20 bg-inherit">
            <div className="flex w-full bg-secondary py-10 rounded-3xl items-stretch pl-5 gap-2">
                <div className="w-1/2 bg-gray-700 flex-col-start-center gap-5 rounded-3xl p-10">
                    <div className="h-1/2">
                ...
                {GitHubAnalyticsdata.map(
                    ({ id, title, icon: Icon, text }, index) => (
                        <div
                            ...
                            } bg-gray-800 rounded-3xl p-6 h-fit flex-col-between-center`}
                        >
