            ...
            <div className="container mx-auto max-w-4xl">
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        ...
                        and use of the website operated by Armaan Jaj ("we,"
                        "our," or "us"). By accessing or using our website, you
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        ...
                        website. You may not engage in any conduct that is
                        unlawful, harmful, or otherwise objectionable.
                    </p>
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        ...
                        property on this website are owned by or licensed to us.
                        You may not reproduce, distribute, or use any of the
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        If you submit or post any content on our website, you
                        grant us a worldwide, non-exclusive, royalty-free
                        license to use, reproduce, modify, and distribute that
                        content in any media. You are solely responsible for the
                        content you submit and must ensure that it does not
                        violate any laws or infringe on any third-party rights.
                    </p>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        ...
                        third-party websites or services. You acknowledge and
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        We disclaim all warranties, including, but not limited
                ...
                <section className="mb-6">
                    ...
                    <p className="text-lg">
                        ...
                        these Terms shall be brought exclusively in the courts
